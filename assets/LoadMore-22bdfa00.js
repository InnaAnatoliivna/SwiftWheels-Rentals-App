import{R as k,d as $,e as D,s as o,j as e,a as E,r as g,g as P,h as z,i as O,k as L,o as T}from"./index-f558015c.js";import{B as R}from"./Button-2118ee0e.js";function W(t=k){const s=t===k?$:D(t);return function(){const{store:i}=s();return i}}const N=W();function H(t=k){const s=t===k?N:W(t);return function(){return s().dispatch}}const F=H(),U=o.div`
display: flex;
width: 274px;
height: 426px;
...
`,le=({advert:t})=>{const{img:s,make:n,year:i,model:a,rentalPrice:c,type:l,id:f,fuelConsumption:p,engineSize:x,functionalities:h,accessories:u,rentalConditions:w,mileage:m}=t,C=t.address.split(",").map(d=>d.trim()),j=C[1],y=C[2],v=w,S=v.split("  ").map(d=>d.trim());return console.log(v),e.jsxs(ie,{children:[e.jsx(ae,{children:e.jsx("img",{src:s,alt:"rental car"})}),e.jsxs("p",{children:[n,e.jsxs("span",{className:"accent",children:[a,","]}),i]}),e.jsxs(I,{children:[e.jsxs("li",{children:[j,"  |"]},r()),e.jsxs("li",{children:[y,"  |"]},r()),e.jsxs("li",{children:["Id: ",f,"  |"]},r()),e.jsxs("li",{children:["Year: ",i,"  |"]},r()),e.jsxs("li",{children:["Type: ",l,"  |"]},r()),e.jsxs("li",{children:["Fuel Concumption: ",p,"  |"]},r()),e.jsxs("li",{children:["Engine Size: ",x,"  |"]},r())]}),e.jsx("p",{children:"Accessories and functionalities:"}),e.jsxs(I,{children:[e.jsxs("li",{children:[u[0],"  |"]},r()),e.jsxs("li",{children:[u[1],"  |"]},r()),e.jsxs("li",{children:[u[2],"  |"]},r()),e.jsxs("li",{children:[h[0],"  |"]},r()),e.jsxs("li",{children:[h[1],"  |"]},r()),e.jsx("li",{children:h[2]},r())]}),e.jsx("p",{children:"Rental Conditions: "}),e.jsxs(I,{children:[e.jsx(A,{children:S[0]},r()),e.jsxs(A,{children:["Mileage: ",m.toLocaleString("en-US",{useGrouping:!0})]},r()),e.jsxs(A,{children:["Price: ",c]},r())]}),e.jsx("div",{children:e.jsx(ce,{href:"tel:+380730000000",children:"Rental car"})})]})},de=({advert:t})=>{const s=F();g.useEffect(()=>{const a=c=>{c.code==="Escape"&&s(L())};return document.addEventListener("keydown",a),()=>{document.removeEventListener("keydown",a)}},[s]),g.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]);const n=a=>{a.currentTarget===a.target&&s(L())},i=()=>s(L());return O.createPortal(e.jsx(se,{onClick:n,children:e.jsxs(re,{children:[e.jsx(ne,{children:e.jsx(oe,{width:"24",height:"24",onClick:i,children:e.jsx("use",{href:`${B}#icon-x`})})}),e.jsx(le,{advert:t})]})}),document.querySelector("#modal-root"))},me=({adverts:t})=>{const s=F(),n=E(J),[i,a]=g.useState(null),c=l=>{s(T()),a(l)};return e.jsxs(ee,{children:[t.map(l=>e.jsx(te,{children:e.jsx(q,{children:e.jsx(Z,{advert:l,handleOpenModal:c})})},l.id)),n&&e.jsx(de,{advert:i})]})},pe=o.div`
    /* margin: 0 auto; */
    display: flex;
    justify-content: center;
